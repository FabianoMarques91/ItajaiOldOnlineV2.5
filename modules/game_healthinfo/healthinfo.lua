...
function init()
  ...
  healthBarLabel = healthInfoWindow:recursiveGetChildById('healthBarLabel')
  manaBarLabel = healthInfoWindow:recursiveGetChildById('manaBarLabel')
...
function onHealthChange(localPlayer, health, maxHealth)
  ...
  healthBarLabel: setText(health, 0, maxHealth)
...
function onManaChange(localPlayer, mana, maxMana)
  ...
  manaBarLabel:setText(mana, 0, maxMana)
