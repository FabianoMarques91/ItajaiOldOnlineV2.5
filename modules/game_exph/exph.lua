...
function init()
  ...
  exphButton =  modules.client_topmenu.addRightGameToggleButton('exphButton', tr('Experience Analyzer (Ctrl+H)'), '/images/topbuttons/analyzers', toggle)
...
function refresh()
	...
	exphWindow:setContentMinimumHeight(125)
	exphWindow:setContentMaximumHeight(125)
