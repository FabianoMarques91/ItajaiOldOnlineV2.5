...
local config = {
  ...
  loopInterval = 25, -- seconds, main loop interval / check mana to make runes & cast spell
...
local foodIds = {
  ...
  2666,3607, 3592, 3600, 3601, 3725, 3582, 3577, 3578, 3583, 3723, 3731, 3732, 3595, 3593,
...
function init()
  ...
  tButton = modules.client_topmenu.addRightGameToggleButton('trainer', tr('Anti-idle'), '/images/topbuttons/inventory', toggleWindow)
